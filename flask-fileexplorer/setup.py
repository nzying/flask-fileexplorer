...
def downloadFolder(var):
    ...
    fPath=pathC[len(pathC)-1]
    fName= fPath +'.zip'
    fullPath = os.getcwd() + '/' + fPath
    try:
        make_zipfile('C:\\Users\\anon_\\Desktop\\abc.zip',fullPath)
        # print(fullPath)
        return send_file('C:\\Users\\anon_\\Desktop\\abc.zip', attachment_filename=fName)
    except:
        return render_template('404.html',errorCode=200,errorText='Permission Denied',favList=favList)
